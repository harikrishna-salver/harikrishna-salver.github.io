...
export default function ExperienceTimeline() {
  ...
  return (
    ...
    >
      ...
      <div className="relative border-l border-gray-800 ml-3 md:ml-6 pl-6 md:pl-8 space-y-6">
        {experience.map((exp, idx) => {
          ...
          return (
            <div key={exp.company + exp.period} className="relative group">
              ...
              <div
                className={`absolute -left-8 md:-left-10 top-1.5 w-4 h-4 rounded-full border-2 transition-all ${
                  isLatest
              ...
              <div className="bg-[#0f1113] border border-gray-800 hover:border-gray-700 hover:bg-[#0f1113]/80 rounded-2xl p-5 md:p-6 transition-all shadow-md">
                <div
                ...
                <AnimatePresence initial={false}>
                  {isExpanded && (
                    ...
                    >
                      <div className="pt-5 mt-5 border-t border-gray-800 space-y-4">
